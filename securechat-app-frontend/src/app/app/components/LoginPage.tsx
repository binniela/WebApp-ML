...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('http://ec2-3-101-119-224.us-west-1.compute.amazonaws.com/auth/login', {
        method: 'POST',
      ...
      await fetch('http://ec2-3-101-119-224.us-west-1.compute.amazonaws.com/auth/keys', {
        method: 'POST',
        headers: { 
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('http://ec2-3-101-119-224.us-west-1.compute.amazonaws.com/auth/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ username, password }),
      })
